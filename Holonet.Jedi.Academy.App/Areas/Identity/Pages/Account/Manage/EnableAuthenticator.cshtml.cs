...
namespace Holonet.Jedi.Academy.App.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public EnableAuthenticatorModel(
            ...
            IOptions<SiteConfiguration> options)
        {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(JediAcademyAppUser user)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode(Config.ApplicationInformation.ApplicationName),
